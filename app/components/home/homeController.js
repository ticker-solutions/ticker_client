...
angular.module('tickerApp').controller('logInController', ['$scope','$location','UserFactory', function ($scope,$location,UserFactory) {
...
angular.module('tickerApp').controller('mainController',function($scope,$rootScope,$timeout,$dialogs,$location){
